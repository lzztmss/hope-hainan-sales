...
if [[ -f "$KEY_FILE" ]]; then
  ...
  PII_ENCRYPTION_KEY_BASE64="${PII_ENCRYPTION_KEY_BASE64:-${LOCAL_KEYS[0]:-}}"
  PII_LOOKUP_HMAC_KEY_BASE64="${PII_LOOKUP_HMAC_KEY_BASE64:-${LOCAL_KEYS[1]:-}}"
fi
